...
Minimalist POS and inventory tracker built on Laravel. Roles: owner, cashier, stock manager.
...
- Cashier: `cashier@ummasbun.test` / `password`
- Stock manager: `stock_manager@ummasbun.test` / `password`

### Demo data

Seed the last 14 days of sales/expenses/inventory:

- `php artisan db:seed --class=DemoDataSeeder`

### Registration

Public registration is disabled by default. To enable it temporarily, set `AUTH_ENABLE_REGISTRATION=true` in `.env`.
